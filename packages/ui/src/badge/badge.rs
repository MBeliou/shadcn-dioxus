...
impl BadgeVariant {
    pub fn class(&self) -> &'static str {
        match self {
            Self::Default => "bg-primary text-primary-foreground [a&]:hover:bg-primary/90 border-transparent",
            Self::Secondary => "bg-secondary text-secondary-foreground [a&]:hover:bg-secondary/90 border-transparent",
            Self::Destructive => "bg-destructive [a&]:hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/70 border-transparent text-white",
...
// TODO: We need to port tailwind variant
